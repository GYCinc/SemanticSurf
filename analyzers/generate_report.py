...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by Semantic Server • {timestamp}</p>
        </div>
    </div>
</body>
</html>
...
def generate_speaker_column(speaker_name: str, analysis: dict) -> str:
    ...
    if 'speaking_rate' in analysis and 'error' not in analysis['speaking_rate']:
        ...
        col_html.append("<h4>🗣️ Speaking Rate</h4>")
    ...
    if 'pauses' in analysis and 'message' not in analysis['pauses']:
        p = analysis['pauses']
        col_html.append("<h4>⏸️ Pause Analysis</h4>")
        col_html.append('<div class="metric">')
    ...
    if 'complexity' in analysis and 'error' not in analysis['complexity']:
        ...
        col_html.append("<h4>📚 Vocabulary Complexity</h4>")
        col_html.append('<div class="metric">')
    ...
    if 'fillers' in analysis:
        f = analysis['fillers']
        col_html.append("<h4>💬 Filler Words</h4>")
        col_html.append('<div class="metric">')
...
def generate_html_report(analysis: dict) -> str:
    ...
    sections.append("<h2>📊 Per-Speaker Analysis</h2>")
    ...
    if 'passion_moments' in analysis and 'message' not in analysis['passion_moments']:
        ...
        sections.append(f"""
        <div class="section">
            <h2>🔥 Passion & Engagement (Session-Wide)</h2>
            <div class="metric">
                <div class="metric-card">
                    <h3>Baseline WPM</h3>
    ...
    if 'grammar_patterns' in analysis and analysis['grammar_patterns']['patterns_found'] > 0:
        ...
        sections.append(f"""
        <div class="section">
            <h2>✏️ Grammar Patterns (Session-Wide)</h2>
            <div class="metric">
                <div class="metric-card">
