    ...
    callback({
      responseHeaders: {
        ...
        "Content-Security-Policy": [
          "default-src 'self' 'unsafe-inline' 'unsafe-eval' ws: http: https: data: blob:;" +
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://unpkg.com https://cdn.tailwindcss.com;" +
          "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.tailwindcss.com blob: data:;" +
          "font-src 'self' https://fonts.gstatic.com;" +
          "connect-src 'self' ws://localhost:8765 http://localhost:8000 https://unpkg.com https://cdn.tailwindcss.com;" +
